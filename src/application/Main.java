            ...
            @Override public void handle(ActionEvent e) {
            	if(graph1.gibStandort().equals("r1") && !graph1.gibRaetselAktiv()) {
            		...
            		story = "Vor der T\u00fcr befinden sich acht S\u00e4ulen mit jeweils einem Regler.\r\n" + 
            				"�Ein Code...� denkst du dir und \u00fcberlegst was f�r ein achtstelliger Code das wohl sein wird, als dir erst jetzt der Schriftzug �ber der T\u00fcr auff\u00e4llst.\r\n" + 
            ...
            @Override public void handle(ActionEvent e) {
            	if(graph1.gibStandort().equals("r1") && graph1.gibRaetselAktiv()) {
            		if(tips == 0) {
           				...
           				storyta.setText(story +"\nWer ist nochmal f�r die US-Streitkr\u00e4fte zust�ndig?");
           				tips++;
           				score = score-1;
        		...
        		if(graph1.gibStandort().equals("r1") && graph1.gibRaetselAktiv()){
        			...
        			if(tf1.getText().toString().equalsIgnoreCase("29")) {
                		...
                		if (counter ==0 ) {
                			...
                			System.out.println(score);
                			storyta.setText("Du hast " +(counter+1)+" Versuche ben\u00f6tigt. \nWillkommen in Raum 4!\nDu hast "+tips+" Tip(s) abgerufen."
                					+ "\n\nDu \u00f6ffnest die T�r, pl\u00f6tzlich fliegen dir ein paar Flederm\u00e4use entgegen. Du schreckst kurz auf und erinnerst dich, dass du schon viel schlimmere Dinge auf deinen Entdeckungstouren erlebst hast als ein paar Flederm\u00e4use.");
                		}
                		counter = 0;
                		tips = 0;
